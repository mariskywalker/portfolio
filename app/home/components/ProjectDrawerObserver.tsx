...
export function ProjectDrawerObserver({
  projectDrawerOpen,
  selectedProject,
  projects,
  activeDrawerCopy,
                  ...
                  {MENU_ENTRIES.map((entry) => (
                    ...
                    >
                      ...
                      <motion.span
                        ...
                        className="flex h-6 w-6 items-center justify-center font-mono text-[13px] tracking-widest text-white"
                      >
                        {entry.n}
                      </motion.span>
                    </button>
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 0.25 }}
                      className="absolute bottom-3 left-4 font-mono text-[13px] uppercase tracking-[0.22em] text-white/50"
                    >
                      {activeSection}
                    </motion.div>
                  </motion.div>
                  ...
                  <div className="space-y-8 p-5 md:p-6">
                    ...
                    >
                      <div className="font-mono text-[13px] uppercase tracking-[0.22em] text-white/62">
                        OVERVIEW
                      </div>
                      <motion.p
                        animate={{
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          {selectedProject.fields.map((field: any) => (
                            <span
                              ...
                              className="border border-white/15 bg-white/[0.03] px-2 py-1 font-mono text-[13px] uppercase tracking-[0.16em] text-white/72"
                            >
                              {field.k}: {field.v}
                            </span>
                          ))}
